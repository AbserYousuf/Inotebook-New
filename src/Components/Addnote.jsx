     ...
     const handlechange=(event)=>{
      ...
      const handleSubmit = (event) => {
        ...
        event.preventDefault();
         const sendtitle = notes.title.trim()
         const sendDescription = notes.description.trim()
         addnotes(sendtitle,sendDescription)
        handleClose();
        setnotes({
          title:"",
          description:""
...
<Divider />
             ...
             value={notes.title}
              ...
              sx={{
                ...
                '& .MuiInputBase-root': {
                  ...
                  fontSize: '1.05rem',
                  minHeight: '120px',            // total height of the field
                  alignItems: 'flex-start',      // ← important: content starts from top
                },
              ...
              variant="standard"
              error={notes.title.length === titleLength }
              helperText={
                notes.title.length === titleLength
  ...
  multiline       
  onChange={handlechange}
  value={notes.description}             // ← enables new lines on Enter
  rows={8}                     // ← initial visible height (adjust as needed)
  maxRows={12} 
  error={notes.description.length === DescriptionLength  }
              helperText={
                notes.description.length === DescriptionLength
